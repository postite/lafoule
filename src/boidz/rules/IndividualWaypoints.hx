...
class IndividualWaypoints implements IFlockRule {
  ...
  public function new(flock : Flock, ?radius : Float = 10, ?maxSteer : Degree) {
    ...
    this.onBoidStep = function(b : IBoid, coords : { x : Float, y : Float }) {};
  ...
  function updateGoalRuleForBoid(b : IBoid) {
    // TODO
    goalRule.x = 100;
    goalRule.y = 200;
  }
